...
<body>
    <header class="header"> 
        <a href="/projectsPHP/ConexaoRH%20PHP/index.php" class="logo">
        ...
        <nav class="nav-bar" aria-label="Menu principal">
            <ul class="linkNav">
                <li> 
                    <a href="./index.php" class="linkPages curadoriaLink linkPagesActive">Início</a>
                </li>
                <li>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="pages/dashboard/dashboard.php" class="loginNav btn-mobile" aria-hidden="true">Dashboard</a>
                <a href="php/logout.php" class="SingninNav btn-mobile" aria-hidden="true">Sair</a>
            <?php else: ?>
                <a href="pages/login/login.html" class="loginNav btn-mobile" aria-hidden="true">Entrar</a>
                <a href="pages/register/register.html" class="SingninNav btn-mobile" aria-hidden="true">Criar</a>
            <?php endif; ?>
        </nav>
        ...
        <div class="linkAcount">
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="pages/dashboard/dashboard.php" class="loginNav actionBtnNav btn">Meu Painel</a>
                <a href="php/logout.php" class="SingninNav actionBtnNav btn">Sair</a>
            <?php else: ?>
                <a href="pages/login/login.html" class="loginNav actionBtnNav btn">Entrar</a>
                <a href="pages/register/register.html" class="SingninNav actionBtnNav btn">Crie sua Conta</a>
            <?php endif; ?>
        </div>
    </header>
    ...
    <main class="page">
        ...
        <section class="funcionalSection">
            ...
            <main class="parentGrid" id="center-nav">
                ...
                <article href="./pages/register/register.html" class="cardTwo">
                ...
                <article href="./pages/curadoria/curadoria.html" class="cardThree">
                ...
                <a href="./pages/login/login.html" class="cardFour">
                    <p class="parentVacancy">As melhores vagas disponíveis te aguardando.</p>
                </a>
                <a href="./pages/conect/conect.html" class="cardFive">
